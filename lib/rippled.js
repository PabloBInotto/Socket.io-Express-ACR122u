...
//xrp Devs tools, Data API v2 / Get Exchange Rates Normalize!

const fetch = require('node-fetch');
fetch('https://data.ripple.com/v2/normalize?amount=1&currency=XRP&exchange_currency=USD&exchange_issuer=rMwjYedjc7qqtKYVLiAccJSmCwih4LnE2q',)
